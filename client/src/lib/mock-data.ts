...
// ============================================================
// T10 — White Label (mock sintético)
// ============================================================
...
export const mockWhiteLabelConfigs: WhiteLabelConfig[] = [
  {
    ...
    clienteTipo: "condominio",
    dominio: "aurora.guardia.app",
    status: "ativo",
    branding: {
    ...
    dominioStatus: "propagado",
    sslStatus: "ativo",
    criadoEm: "2026-06-15T10:00:00Z",
    atualizadoEm: "2026-07-20T14:30:00Z",
  },
  {
    id: "wl2",
    clienteNome: "Colégio Monte Serrat",
    clienteTipo: "escola",
    dominio: "montesserat.guardia.app",
    status: "ativo",
    branding: {
    ...
    atualizadoEm: "2026-07-18T11:15:00Z",
  },
  {
    id: "wl3",
    clienteNome: "Condomínio Residencial Parque das Águas",
    clienteTipo: "condominio",
    dominio: "parqueaguas.guardia.app",
    status: "pendente",
    branding: {
      marcaNome: "Águas Control",
      logoUrl: "",
      corPrimaria: "#0D7377",
      corSecundaria: "#14A098",
      corAcento: "#E0FBFC",
    ...
    dominioStatus: "propagando",
    sslStatus: "pendente",
    criadoEm: "2026-07-22T16:00:00Z",
    atualizadoEm: "2026-07-22T16:00:00Z",
  },
  {
    id: "wl4",
    clienteNome: "TechPark Empresarial",
    clienteTipo: "empresa",
    dominio: "techpark.guardia.app",
    status: "ativo",
    branding: {
    ...
    atualizadoEm: "2026-07-25T10:00:00Z",
  },
  {
    id: "wl5",
    clienteNome: "Condomínio Jardim Botânico",
    clienteTipo: "condominio",
    dominio: "jardimbotanico.guardia.app",
    status: "suspenso",
    branding: {
      marcaNome: "Jardim Seguro",
      logoUrl: "",
      corPrimaria: "#2D5016",
      corSecundaria: "#4A7C2E",
      corAcento: "#C4D5A0",
      fontFamily: "Inter, sans-serif",
    },
    personalizacoes: {
    ...
    atualizadoEm: "2026-06-30T18:00:00Z",
  },
  {
    id: "wl6",
    clienteNome: "Escola Nova Geração",
    clienteTipo: "escola",
    dominio: "novageracao.guardia.app",
    status: "ativo",
    branding: {
      marcaNome: "NG Campus",
      logoUrl: "/guardia-percebe-logo.png",
    ...
    dominioStatus: "propagado",
    sslStatus: "ativo",
    criadoEm: "2026-06-28T14:00:00Z",
    atualizadoEm: "2026-07-26T09:45:00Z",
  },
];
